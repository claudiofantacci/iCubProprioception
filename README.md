...
The iCubProprioception project provides an augmented-reality app to visualize the iCub proprioception.
The iCub limbs are superimposed on the camera images.
